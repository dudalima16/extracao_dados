...
"""além disso, precisamos enviar por e-mail para o RH uma lista com o nome e o cargo de cada pessoa da tabela, então você precisa construir o texto do corpo desse email do tipo:"""

texto = "RH, segue a lista dos funcionários"

"""
    para cada item das nossas informações:
    -pegar o nome do funcionário -> tupla[1]
    -pegar o cargo do funcionário -> tupla[2]
    -add uma nova linha no txt e add Fulano, Cargo: tal 
"""
